...
int main()
{
     ...
     while (1)
    {
        ...
        bresenham({0, 100}, {200, 0}, RGB(0, 255, 0));
        bresenham({0, 100}, {200, 50}, RGB(0, 255, 0));
        bresenham({0, 100}, {200, 100}, RGB(0, 255, 0));
        bresenham({0, 100}, {200, 150}, RGB(0, 255, 0));
        bresenham({0, 100}, {200, 200}, RGB(0, 255, 0));

        bresenham({0, 200}, {200, 300}, RGB(255, 0, 0));
        bresenham({0, 250}, {200, 300}, RGB(255, 0, 0));
        bresenham({0, 300}, {200, 300}, RGB(255, 0, 0));
        bresenham({0, 350}, {200, 300}, RGB(255, 0, 0));
        bresenham({0, 400}, {200, 300}, RGB(255, 0, 0));

        bresenham({50, 400}, {15, 500}, RGB(0, 0, 255));
        bresenham({50, 400}, {50, 500}, RGB(0, 0, 255));
        bresenham({50, 400}, {85, 500}, RGB(0, 0, 255));
